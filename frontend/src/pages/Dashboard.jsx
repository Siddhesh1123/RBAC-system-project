...
const Dashboard = () => {
  ...
  const handleEditUser = (user) => {
    ...
    setFormData({
      ...
      email: user.email,
      password: "", // Optional: Do not pre-fill password during editing
      role: user.role._id,
    });
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-base-200 ">
      <div className="bg-gray-800 p-6 rounded-lg shadow-lg w-full m-20">
        <div className="flex flex-row justify-between items-center">
          <div>
            <h1 className="text-6xl font-bold text-left text-slate-400  mb-4">
              Welcome, {auth.user.username}!
            </h1>
            <p className="text-4xl text-left text-slate-500  mb-6">
              Your Role is :{" "}
        ...
        <div className="mt-14">
          ...
          <h2 className="text-3xl font-semibold text-slate-400  mb-3 flex justify-between">
            User List
